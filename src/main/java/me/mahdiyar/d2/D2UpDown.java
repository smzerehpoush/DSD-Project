...
public class D2UpDown extends Canvas {
    ...
    protected D2CustomAWT listener;
    int xpoints[];
    int ypoints[];
    ...
    public D2UpDown(int i, int j, Color color, Color color1) {
        topPressed = false;
        bottomPressed = false;
        arrowColor = color;
        bkgdColor = color1;
    ...
    public void addListener(D2CustomAWT customawt) {
        listener = customawt;
    }
