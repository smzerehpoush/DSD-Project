...
public abstract class MosOperationPanel extends Panel implements CustomAWT {
    ...
    protected UpDownCanvas udVgs;
    protected UpDownCanvas udVd;
    ...
    public MosOperationPanel(FunctionData functiondata, MosDevCircuit mosdevcircuit) {
        setLayout(null);
    ...
    public void setVgsControl(UpDownCanvas updown) {
        udVgs = updown;
    }

    public void setVdControl(UpDownCanvas updown) {
        udVd = updown;
    }
